...
//= require jquery_ujs
// require_tree .
//= stub ckeditor/ckeditor
// stub ckeditor/ckeditor/plugins
...
function update_list_product(url,item){
  //$.get( url, { "order_by": item.value} );
  window.location.href = url+"?order_by="+item.value
}
